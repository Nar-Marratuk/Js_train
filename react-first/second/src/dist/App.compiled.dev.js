    ...
    var App = _wrapComponent('App')(function (_React$Component) {
      ...
      _createClass(App, [{
        ...
        value: function render() {
          return _react3["default"].createElement('div', null, _react3["default"].createElement('h1', null, 'Video Player'), _react3["default"].createElement(_Menu.Menu, {
    ...
    var Menu = exports.Menu = _wrapComponent("Menu")(function (_React$Component) {
      ...
      _createClass(Menu, [{
        ...
        value: function handleClick(e) {
          var newVideo = e.target.value;
          this.props.chooseVideo(newVideo);
        }
      }, {
        key: "render",
        value: function render() {
          return _react3["default"].createElement("form", {
            onClick: this.handleClick
          }, _react3["default"].createElement("input", {
            type: "radio",
            name: "src",
            value: "fast"
          }), " fast", _react3["default"].createElement("input", {
            type: "radio",
            name: "src",
            value: "slow"
          }), " slow", _react3["default"].createElement("input", {
            type: "radio",
            name: "src",
            value: "cute"
          }), " cute", _react3["default"].createElement("input", {
            type: "radio",
            name: "src",
            value: "eek"
          }), " eek");
  ...
  4: [function (require, module, exports) {
    ...
    var Video = exports.Video = _wrapComponent('Video')(function (_React$Component) {
      ...
      _createClass(Video, [{
        key: 'render',
        value: function render() {
          return _react3["default"].createElement('div', null, _react3["default"].createElement('video', {
            controls: true,
            autostart: true,
            autoPlay: true,
            muted: true,
